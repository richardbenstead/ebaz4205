...
#
# EBAZ4205_Petalinux_Base.tcl: Tcl script for re-creating project 'EBAZ4205_Petalinux_Base'
#
# Generated by Vivado on Fri Sep 10 17:43:33 AEST 2021
...
#
# 1. This project restoration tcl script (EBAZ4205_Petalinux_Base.tcl) that was generated.
#
...
#
#    "/home/richard/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/sources_1/new/testVerilog.v"
#    "/home/richard/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/constrs_1/new/zync_constr.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/sources_1/new/testVerilog.v"]"\
 "[file normalize "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/constrs_1/new/zync_constr.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "EBAZ4205_Petalinux_Base"
...
set script_file "EBAZ4205_Petalinux_Base.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/Vivado/EBAZ4205_Petalinux_Base"]"
...
set file "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/sources_1/new/testVerilog.v"
...
set_property -name "top" -value "Zynq_proc_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/constrs_1/new/zync_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/constrs_1/new/zync_constr.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/constrs_1/new/zync_constr.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7z010clg400-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.srcs/constrs_1/new/zync_constr.xdc"]" -objects $obj
...
# Proc to create BD Zynq_proc
proc cr_bd_Zynq_proc { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name Zynq_proc
...
proc create_hier_cell_gpio { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 2 -to 0 Data1_GPIO
  create_bd_pin -dir I -from 63 -to 0 Din
  create_bd_pin -dir O -from 1 -to 0 LEDS
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins LEDS] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins Data1_GPIO] [get_bd_pins xlslice_2/Dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}
  
# Hierarchical cell: ENET_4_to_8
proc create_hier_cell_ENET_4_to_8 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_ENET_4_to_8() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net In0_0_1 [get_bd_pins enet0_gmii_rxd] [get_bd_pins xlconcat_1/In0]
  ...
  # Create ports
  set Data1_GPIO [ create_bd_port -dir O -from 2 -to 0 Data1_GPIO ]
  ...
  # Create instance: ENET_4_to_8
  create_hier_cell_ENET_4_to_8 [current_bd_instance .] ENET_4_to_8
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {NAND Flash#GPIO#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND\
...
0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO}\
  ...
  connect_bd_net -net In0_0_1 [get_bd_ports enet0_gmii_rxd] [get_bd_pins ENET_4_to_8/enet0_gmii_rxd]
  connect_bd_net -net gpio_Data1_GPIO [get_bd_ports Data1_GPIO] [get_bd_pins gpio/Data1_GPIO]
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins gpio/Din] [get_bd_pins processing_system7_0/GPIO_O]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins ENET_4_to_8/dout] [get_bd_pins processing_system7_0/ENET0_GMII_RXD]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins high/dout] [get_bd_pins processing_system7_0/SPI0_SS_I]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports enet0_gmii_txd] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports LEDS] [get_bd_pins gpio/LEDS]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-405,-134",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port FIXED_IO -pg 1 -lvl 3 -x 850 -y 290 -defaultsOSRD
preplace port DDR -pg 1 -lvl 3 -x 850 -y 270 -defaultsOSRD
preplace port MDIO_ETHERNET_0_0 -pg 1 -lvl 3 -x 850 -y 140 -defaultsOSRD
preplace port port-id_FCLK_CLK1 -pg 1 -lvl 3 -x 850 -y 470 -defaultsOSRD
preplace port port-id_ENET0_GMII_TX_CLK_0 -pg 1 -lvl 0 -x 0 -y 600 -defaultsOSRD
preplace port port-id_ENET0_GMII_RX_DV_0 -pg 1 -lvl 0 -x 0 -y 580 -defaultsOSRD
preplace port port-id_ENET0_GMII_RX_CLK_0 -pg 1 -lvl 0 -x 0 -y 560 -defaultsOSRD
preplace port port-id_SPI0_SCLK_O -pg 1 -lvl 3 -x 850 -y 330 -defaultsOSRD
preplace port port-id_SPI0_MOSI_O -pg 1 -lvl 3 -x 850 -y 350 -defaultsOSRD
preplace port port-id_SPI0_SS_O -pg 1 -lvl 3 -x 850 -y 390 -defaultsOSRD
preplace port port-id_SPI0_SS1_O -pg 1 -lvl 3 -x 850 -y 410 -defaultsOSRD
preplace portBus ENET0_GMII_TX_EN_0 -pg 1 -lvl 3 -x 850 -y 20 -defaultsOSRD
preplace portBus enet0_gmii_txd -pg 1 -lvl 3 -x 850 -y 80 -defaultsOSRD
preplace portBus enet0_gmii_rxd -pg 1 -lvl 0 -x 0 -y 660 -defaultsOSRD
preplace portBus LEDS -pg 1 -lvl 3 -x 850 -y 200 -defaultsOSRD
preplace portBus Data1_GPIO -pg 1 -lvl 3 -x 850 -y 220 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 260 -y 280 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 2 -x 700 -y 80 -defaultsOSRD
preplace inst ENET_4_to_8 -pg 1 -lvl 1 -x 260 -y 660 -defaultsOSRD
preplace inst gpio -pg 1 -lvl 2 -x 700 -y 210 -defaultsOSRD
preplace inst high -pg 1 -lvl 1 -x 260 -y 750 -defaultsOSRD
preplace netloc ENET0_GMII_RX_CLK_0_1 1 0 2 NJ 560 530
preplace netloc ENET0_GMII_RX_DV_0_1 1 0 2 NJ 580 520
preplace netloc ENET0_GMII_TX_CLK_0_1 1 0 2 NJ 600 510
preplace netloc In0_0_1 1 0 1 NJ 660
preplace netloc gpio_Data1_GPIO 1 2 1 NJ 220
preplace netloc processing_system7_0_ENET0_GMII_TXD 1 1 1 550J 80n
preplace netloc processing_system7_0_ENET0_GMII_TX_EN 1 1 2 540J 20 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 20 550 480
preplace netloc processing_system7_0_FCLK_CLK1 1 1 2 NJ 470 NJ
preplace netloc processing_system7_0_GPIO_O 1 1 1 550 210n
preplace netloc processing_system7_0_SPI0_MOSI_O 1 1 2 NJ 350 NJ
preplace netloc processing_system7_0_SPI0_SCLK_O 1 1 2 NJ 330 NJ
preplace netloc processing_system7_0_SPI0_SS1_O 1 1 2 NJ 410 NJ
preplace netloc processing_system7_0_SPI0_SS_O 1 1 2 NJ 390 NJ
preplace netloc xlconcat_1_dout 1 1 1 500 190n
preplace netloc xlconstant_0_dout 1 1 1 490 370n
preplace netloc xlslice_0_Dout 1 2 1 NJ 80
preplace netloc xlslice_1_Dout 1 2 1 NJ 200
preplace netloc processing_system7_0_DDR 1 1 2 NJ 270 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 2 NJ 290 NJ
preplace netloc processing_system7_0_MDIO_ETHERNET_0 1 1 2 540J 140 NJ
levelinfo -pg 1 0 260 700 850
pagesize -pg 1 -db -bbox -sgen -190 0 1070 810
"
}
...
# End of cr_bd_Zynq_proc()
cr_bd_Zynq_proc ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files Zynq_proc.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files Zynq_proc.bd ] 
set_property IS_ENABLED "1" [get_files Zynq_proc.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files Zynq_proc.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files Zynq_proc.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files Zynq_proc.bd ] 
set_property PFM_NAME "" [get_files Zynq_proc.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files Zynq_proc.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files Zynq_proc.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files Zynq_proc.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files Zynq_proc.bd ] 
set_property USED_IN_SIMULATION "1" [get_files Zynq_proc.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files Zynq_proc.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse Zynq_proc.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/projects/ebaz4205/Vivado/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.gen/sources_1/bd/Zynq_proc/hdl/Zynq_proc_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse Zynq_proc.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/EBAZ4205_Petalinux_Base.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/EBAZ4205_Petalinux_Base.srcs/utils_1/imports/impl_1" -objects $obj
